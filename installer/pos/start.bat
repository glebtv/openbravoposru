...
set CP=%CP%;"%DIRNAME%lib/jasperreports-4.5.0.jar"
set CP=%CP%;"%DIRNAME%lib/jcommon-1.0.17.jar"
set CP=%CP%;"%DIRNAME%lib/jfreechart-1.0.14.jar"
...
set CP=%CP%;"%DIRNAME%lib/bcd4j-1.1.jar"
