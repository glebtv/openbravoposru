...
public abstract class PrinterCommand 
{
    ...
    private void checkMinLength(int length, int minLength)
        throws Exception
    {
        if (length < minLength)
    ...
    public abstract void encode(CommandOutputStream out) 
        throws Exception;
    
    public abstract void decode(CommandInputStream in)
        throws Exception;
}
