...
public class DeviceScaleVPMException extends java.lang.Exception {
    ...
    public DeviceScaleVPMException() {
    }

    public DeviceScaleVPMException(String msg) {
        super(msg);
    }

    public DeviceScaleVPMException(String msg, Throwable cause) {
        super(msg, cause);
    }

    public DeviceScaleVPMException(Throwable cause) {
        super(cause);
    }
}
