...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('0', 'Привилегия администратора', $FILE{/com/openbravo/pos/templates/Role.Administrator.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('1', 'Привилегия руководителя', $FILE{/com/openbravo/pos/templates/Role.Manager.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('2', 'Привилегия оператора', $FILE{/com/openbravo/pos/templates/Role.Employee.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('3', 'Привилегия гостя', $FILE{/com/openbravo/pos/templates/Role.Guest.xml} );
...
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('0', 'Администратор', NULL, '0', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('1', 'Руководитель', NULL, '1', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('2', 'Оператор', NULL, '2', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('3', 'Гость', NULL, '3', TRUE, NULL);
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('000', 'Без НДС', '000', NULL, NULL, 0, FALSE, NULL);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', 'НДС', '001', NULL, NULL, 0.10, FALSE, NULL);
...
INSERT INTO LOCATIONS(ID, NAME,ADDRESS) VALUES('0', 'Основной', NULL);
...
INSERT INTO FLOORS(ID, NAME, IMAGE) VALUES ('0', 'Этаж ресторана', $FILE{/com/openbravo/pos/templates/restaurantsample.png});
