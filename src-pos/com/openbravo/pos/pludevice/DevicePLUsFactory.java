...
import com.openbravo.pos.pludevice.massakvpm.DeviceScaleVPMComm;
...
public class DevicePLUsFactory {
    ...
    public static DevicePLUs createInstance(Component parent, AppProperties props) {
        ...
        } else if ("mercury130kz039".equals(sDevicePLUType)) {
            return new DeviceMercury130Comm(sDevicePLUParam1, iDevicePLUSerialPortSpeed, iDevicePLUSerialPortDataBits, iDevicePLUSerialPortStopBits, iDevicePLUSerialPortParity);
        } else if ("massakvpm".equals(sDevicePLUType)) {
            return new DeviceScaleVPMComm(sDevicePLUType, sDevicePLUParam1, iDevicePLUSerialPortSpeed, iDevicePLUSerialPortDataBits, iDevicePLUSerialPortStopBits, iDevicePLUSerialPortParity);
        } else {
            return null;
        }
    }
